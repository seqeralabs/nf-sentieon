# nf-core/sentieon: Usage

## :warning: Please read this documentation on the nf-core website: [https://nf-co.re/sentieon/usage](https://nf-co.re/sentieon/usage)
...
CONTROL_REP1,H88WKADXX.1.CGATGT-2,U0a,ILLUMINA,AEG588A1_S1_L003_R1_001.fastq.gz,AEG588A1_S1_L003_R2_001.fastq.gz
CONTROL_REP1,H88WKADXX.1.CGATGT-3,U0a,ILLUMINA,AEG588A1_S1_L004_R1_001.fastq.gz,AEG588A1_S1_L004_R2_001.fastq.gz
```
...
TREATMENT_REP1,H88WKADXX.1.CGATGT-4,U3a,ILLUMINA,AEG588A4_S4_L003_R1_001.fastq.gz,
TREATMENT_REP2,H88WKADXX.1.CGATGT-5,U4a,ILLUMINA,AEG588A5_S5_L003_R1_001.fastq.gz,
TREATMENT_REP3,H88WKADXX.1.CGATGT-6,U5a,ILLUMINA,AEG588A6_S6_L003_R1_001.fastq.gz,
TREATMENT_REP3,H88WKADXX.1.CGATGT-7,U5a,ILLUMINA,AEG588A6_S6_L004_R1_001.fastq.gz,
```
...
```console
nextflow run nf-core/sentieon --input samplesheet.csv --genome GRCh37 -profile docker
```
...
```console
nextflow pull nf-core/sentieon
```
...
First, go to the [nf-core/sentieon releases page](https://github.com/nf-core/sentieon/releases) and find the latest version number - numeric only (eg. `1.3.1`). Then specify this when running the pipeline with `-r` (one hyphen) - eg. `-r 1.3.1`.
